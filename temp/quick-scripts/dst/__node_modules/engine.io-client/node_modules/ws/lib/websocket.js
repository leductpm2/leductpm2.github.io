                ...
                (function() {
                    ...
                    var __filename = 'preview-scripts/__node_modules/engine.io-client/node_modules/ws/lib/websocket.js';
...
cc._RF.push(module, '9b975jzF8ZMcrRn9WVUASpd', 'websocket');
// socketIOServer/node_modules/engine.io-client/node_modules/ws/lib/websocket.js
...
function initAsClient(address, protocols, options) {
  ...
  if (_typeof(address) === 'object' && address.href !== undefined) {
    parsedUrl = address;
  ...
  var path = parsedUrl.search ? "".concat(parsedUrl.pathname || '/').concat(parsedUrl.search) : parsedUrl.pathname || '/';
  ...
  if (options.perMessageDeflate) {
    ...
    options.headers['Sec-WebSocket-Extensions'] = extension.format(_defineProperty({}, PerMessageDeflate.extensionName, perMessageDeflate.offer()));
  }
  ...
  req.on('response', function (res) {
    ...
    abortHandshake(_this3, req, "Unexpected server response: ".concat(res.statusCode));
  });
