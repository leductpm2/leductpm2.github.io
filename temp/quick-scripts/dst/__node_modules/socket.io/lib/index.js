                ...
                (function() {
                    ...
                    var __filename = 'preview-scripts/__node_modules/socket.io/lib/index.js';
                    ...
                    function __define (exports, require, module) {
                        if (!nodeEnv) {__quick_compile_project__.registerModule(__filename, module);}(function (__dirname){
"use strict";
cc._RF.push(module, '26e33xc9r9J8b2Igeji5IDo', 'index');
// socketIOServer/node_modules/socket.io/lib/index.js
...
Server.prototype.serveClient = function (v) {
  ...
  var resolvePath = function resolvePath(file) {
...
Server.prototype.checkNamespace = function (name, query, fn) {
  ...
  var run = function run() {
    ...
    nextFn.value(name, query, function (err, allow) {
      if (err || !allow) {
        run();
      } else {
        fn(_this.parentNsps.get(nextFn.value).createChild(name));
      }
    });
  };
...
Server.prototype.of = function (name, fn) {
  if (typeof name === 'function' || name instanceof RegExp) {
    var parentNsp = new ParentNamespace(this);
...
cc._RF.pop();
}).call(this,"/assets\\socketIOServer\\node_modules\\socket.io\\lib")
                    }
                    if (nodeEnv) {
